    ...
    // ── DASHBOARD ──
        ...
        app.innerHTML = `
            ...
            <div style="max-width:${IS_MOBILE ? '100%' : '1400px'};margin:auto;padding:${IS_MOBILE ? '16px 12px' : '32px 24px'};">
                ...
                ${IS_MOBILE ? '' : `<div class="fab btn-yellow-gradient" onclick="openCVModal()" title="Actualizar perfil profesional"><i class="fas fa-id-card"></i></div>`}` : ''}
                ${IS_MOBILE && currentUser.rol === 'usuario' ? `
                <button onclick="openCVModal()" style="width:100%;margin-bottom:16px;padding:16px 20px;border-radius:20px;background:linear-gradient(135deg,rgba(255,215,0,0.15),rgba(255,140,0,0.08));border:1.5px solid rgba(255,215,0,0.3);display:flex;align-items:center;gap:14px;cursor:pointer;text-align:left;box-shadow:0 4px 20px rgba(255,165,0,0.12);transition:0.2s;">
                    <div style="width:44px;height:44px;border-radius:14px;background:linear-gradient(135deg,#FFD700,#FFA500);display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 4px 12px rgba(255,165,0,0.35);">
                        <i class="fas fa-id-card" style="color:#1a1000;font-size:1.1rem;"></i>
                    </div>
                    <div style="flex:1;min-width:0;">
                        <div style="font-size:0.82rem;font-weight:800;color:#FFD700;letter-spacing:0.2px;">Mi Perfil Profesional</div>
                        <div style="font-size:0.68rem;color:rgba(255,255,255,0.45);margin-top:2px;">Editar y publicar tu perfil</div>
                    </div>
                    <i class="fas fa-chevron-right" style="color:rgba(255,215,0,0.5);font-size:0.75rem;flex-shrink:0;"></i>
                </button>` : ''
