...
function openCVModal() {
    ...
    Object.assign(modal.style, { position: 'fixed', inset: '0', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: '10000', padding: '5px', background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(6px)' });
    Object.assign(modal.style, { position: 'fixed', inset: '0', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: '10000', padding: '5px', background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(6px)' });
    modal.innerHTML = `
...
function openJobDetails(id) {
    ...
    Object.assign(modal.style, { position: 'fixed', inset: '0', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', zIndex: '10000', padding: '5px', background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(10px)', overflow: 'hidden' });
    modal.innerHTML = `
