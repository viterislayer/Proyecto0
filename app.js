...
function mobileBottomNav(active) {
    ...
    return `
    <nav style="position:fixed;bottom:0;left:0;right:0;background:rgba(7,7,15,0.97);backdrop-filter:blur(30px);border-top:1px solid rgba(255,255,255,0.07);display:flex;justify-content:space-around;align-items:center;padding:7px 0;z-index:99;">
        ${items.map(it => `
...
async function render(view) {
    ...
    // ── MIS POSTULACIONES ──
        ...
        try {
            ...
            app.innerHTML = `
                ...
                <div style="max-width:900px;margin:${IS_MOBILE ? '0' : '40px'} auto;padding:${IS_MOBILE ? '16px' : '0 20px'};">
                    ${aceptadas.length > 0 ? `
    ...
    // ── SOPORTE ──
        ...
        app.innerHTML = `
            ...
            <div style="max-width:640px;margin:${IS_MOBILE ? '0' : '40px'} auto;padding:${IS_MOBILE ? '16px' : '0 20px'};">
