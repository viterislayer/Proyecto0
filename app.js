...
function openJobDetails(id) {
    ...
    Object.assign(modal.style, { position: 'fixed', inset: '0', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', zIndex: '10000', padding: '20px', background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(10px)', overflowY: 'auto' });
    modal.innerHTML = `<div class="glass" style="margin:auto; width:min(760px,95%); background:rgba(0,0,0,0.9); border-radius: 28px;">;it:auto;">
                <!-- Columna Izquierda: Identidad y Datos Rápidos -->i:px 25px;background:rgba(255,255,255,0.015);border-right:1px solid rgba(255,255,255,0.05);display:flex;flex-direction:column;align-items:center;text-align:center;position:relative;">
                    <button onclick="closeJobDetailsModal()" style="position:absolute;top:20px;left:20px;background:rgba(255,255,255,0.05);border:none;color:#fff;width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-cont
