...
function mobileBottomNav(active) {
    ...
    return `
    <nav style="position:fixed;top:56px;left:0;right:0;background:rgba(7,7,15,0.97);backdrop-filter:blur(30px);border-bottom:1px solid rgba(255,255,255,0.07);display:flex;justify-content:space-around;align-items:center;padding:7px 0;z-index:99;">
        ${items.map(it => `
...
async function render(view) {
    ...
    // ── DASHBOARD ──
        ...
        app.innerHTML = `
            ...
            `}
            <div style="max-width:${IS_MOBILE ? '100%' : '1400px'};margin:auto;padding:${IS_MOBILE ? (currentUser.rol === 'usuario' ? '54px 12px 80px' : '54px 12px 16px') : '32px 24px'};">
    ...
    // ── MIS POSTULACIONES ──
        ...
        try {
            ...
            app.innerHTML = `
                ...
                <div style="max-width:900px;margin:${IS_MOBILE ? '0' : '40px'} auto;padding:${IS_MOBILE ? '60px 16px 20px' : '0 20px'};">
                    ${aceptadas.length > 0 ? `
    ...
    // ── POSTULACIONES EMPRESA ──
        ...
        try {
            ...
            app.innerHTML = `
                ...
                <!-- HERO HEADER -->
                <div style="background:linear-gradient(160deg,rgba(10,132,255,0.12) 0%,transparent 60%);border-bottom:1px solid rgba(255,255,255,0.05);padding:${IS_MOBILE ? '86px 20px 28px' : '48px 40px 38px'};text-align:center;">
    ...
    // ── PERFIL ──
        ...
        app.innerHTML = `
            ...
            <div class="centered-view" style="${IS_MOBILE ? 'align-items:flex-start;padding-top:60px;' : ''}">
                <div style="max-width:680px;width:100%;padding:${IS_MOBILE ? '0 16px 20px' : '0 20px'};">
    ...
    // ── SOPORTE ──
        ...
        app.innerHTML = `
            ...
            <div style="max-width:640px;margin:${IS_MOBILE ? '0' : '40px'} auto;padding:${IS_MOBILE ? '60px 16px 20px' : '0 20px'};">
