            ...
            <div style="display:flex;flex-wrap:wrap;min-height:500px;">
                ...
                <div style="flex:1.5;min-width:320px;padding:40px 35px;">
                    <div style="margin-bottom:30px;">
                        ...
                        <div style="font-size:2.4rem;font-weight:900;color:#fff;text-shadow: 0 0 20px rgba(255,255,255,0.1);">${cv.moneda && (cv.moneda === 'Q' || cv.moneda === '$') ? cv.moneda : 'Q'} ${item.salario_deseado !== undefined && item.salario_deseado !== null ? String(item.salario_deseado) : '0'}</div>
                            ...
                            <div class="glass job-card profile-card" data-candidate-id="${item.id}" style="animation-delay:${i * 0.06}s;">
                                <div class="card-content">
                                    ...
                                    <div style="text-align:center;margin-bottom:6px;">
                                        ...
                                        <div style="font-size:0.8rem;color:rgba(255,255,255,0.5);font-weight:700;text-transform:uppercase;letter-spacing:0.8px;margin-bottom:28px;">📍 ${cv.ubicacion || 'Ubicación no ingresada'}</div>
                                        ...
                                        <div style="font-size:2.2rem;font-weight:900;color:#fff;line-height:1;letter-spacing:-1px;text-shadow: 0 0 15px rgba(255,255,255,0.15);">${cv.moneda && (cv.moneda === 'Q' || cv.moneda === '$') ? cv.moneda : 'Q'} ${item.salario_deseado !== undefined && item.salario_deseado !== null ? String(item.salario_deseado) : '0'}</div>
