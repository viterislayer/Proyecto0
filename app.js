    ...
    modal.innerHTML = `
        <div class="modal-content glass" style="margin:auto; max-width:520px; width:95%; max-height: 80vh; overflow-y: auto; overscroll-behavior: contain; padding:36px; border:1px solid rgba(58,148,255,0.18);">
            ...
            <form id="cvForm">
                ...
                <div style="margin-bottom:16px;">
                    <label style="display:block;font-size:0.75rem;color:#0a84ff;margin-bottom:8px;margin-left:16px;font-weight:700;text-transform:uppercase;letter-spacing:0.8px;">Link de redes sociales</label>
                    <div class="input-group" style="margin:0;">
...
function openJobDetails(id) {
    ...
    Object.assign(modal.style, { position: 'fixed', inset: '0', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', zIndex: '10000', padding: '2px', background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(10px)', overflow: 'hidden' });
    modal.innerHTML = `
    ...
    if (innerDiv) {
        innerDiv.style.maxHeight = '100vh';
            ...
            <div style="display:flex;justify-content:center;align-items:center;min-height:100vh;padding:24px;">
                <div class="glass responsive-card" style="padding:54px 48px;width:460px;max-width:100%;text-align:center;border:1.5px solid rgba(10,132,255,0.25);box-shadow: 0 30px 80px rgba(0,0,0,0.6), inset 0 0 10px rgba(10,132,255,0.05);">
                    ...
                    <form id="loginForm">
                        ...
                        <div style="margin-bottom:32px;"><div class="input-group" style="margin:0;"><input type="password" name="password" placeholder="Contraseña" required style="background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.06); color:#fff; padding:16px 52px 16px 18px;">
                            <div class="password-toggle" onclick="togglePass('password')" style="right:18px;"><i class="fas fa-eye"></i></div>
                        <div style="margin-bottom:32px;"><div class="input-group" style="margin:0;"><input type="password" name="password" placeholder="Contraseña" required style="background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.06); color:#fff; padding:16px 70px 16px 18px; padding-left:18px;">
            ...
            <div style="display:flex;justify-content:center;align-items:center;min-height:100vh;padding:24px;">
                <div class="glass responsive-card" style="padding:50px 48px;width:560px;max-width:100%;">
                    ...
                    <form id="registroForm">
                        ...
                        <div style="margin-bottom:20px;"><div class="input-group" style="margin:0;"><input name="password" type="password" placeholder="Contraseña" required style="background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.05); color:#fff; padding:16px 52px 16px 18px;">
                        <div style="margin-bottom:20px;"><div class="input-group" style="margin:0;"><input name="password" type="password" placeholder="Contraseña" required style="background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.05); color:#fff; padding:16px 70px 16px 18px; padding-left:18px;">
                            <div class="password-toggle" onclick="togglePass('password')" style="right:18px;"><i class="fas fa-eye"></i></div>
                        </div></div>
                        <div style="margin-bottom:24px;"><div class="input-group" style="margin:0;"><input name="confirm_password" type="password" placeholder="Confirmar contraseña" required style="background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.05); color:#fff; padding:16px 52px 16px 18px;">
                        <div style="margin-bottom:24px;"><div class="input-group" style="margin:0;"><input name="confirm_password" type="password" placeholder="Confirmar contraseña" required style="background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.05); color:#fff; padding:16px 70px 16px 18px; padding-left:18px;">
                            <div class="password-toggle" onclick="togglePass('confirm_password')" style="right:18px;"><i class="fas fa-eye"></i></div>
                        </div></div>
                    ...
                    <div class="glass" style="padding:44px;text-align:center;">
                        ...
                        <form id="perfilForm" style="text-align:left;">
                            ...
                            <div class="input-group">
                                <input name="password" type="password" placeholder="Nueva contraseña (opcional)" autocomplete="new-password" style="padding:16px 70px 16px 18px;">
                                <div class="password-toggle" onclick="togglePass('password')"><i class="fas fa-eye"></i></div>
                            </div>
                            <div class="input-group" style="margin-top:10px;">
                                <input name="confirm_password" type="password" placeholder="Confirmar nueva contraseña" autocomplete="new-password" style="padding:16px 70px 16px 18px;">
