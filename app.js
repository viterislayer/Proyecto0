...
function openJobDetails(id) {
    ...
    Object.assign(modal.style, { position: 'fixed', inset: '0', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', zIndex: '10000', padding: '20px', background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(10px)', overflow: 'hidden' });
    modal.innerHTML = `
