                ...
                <div style="max-width:1100px;margin:auto;padding:${IS_MOBILE ? '24px 16px' : '40px 32px'};">
                    ...
                    ` : empleosConPostulantes.map(empleo => `
                        <div style="margin-bottom:44px;">
                            ...
                            <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;padding:${IS_MOBILE?'15px 18px':'18px 24px'};background:linear-gradient(135deg,rgba(10,132,255,0.09),rgba(10,132,255,0.02));border:1px solid rgba(10,132,255,0.2);border-left:4px solid #0a84ff;border-radius:16px;margin-bottom:12px;box-shadow:0 4px 20px rgba(10,132,255,0.06);">
                                <div style="display:flex;align-items:center;gap:14px;">
                                    <div style="width:${IS_MOBILE?'38px':'46px'};height:${IS_MOBILE?'38px':'46px'};border-radius:13px;background:linear-gradient(135deg,rgba(10,132,255,0.2),rgba(10,132,255,0.08));border:1px solid rgba(10,132,255,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 0 12px rgba(10,132,255,0.15);">
                                        <i class="fas fa-briefcase" style="color:#0a84ff;font-size:${IS_MOBILE?'1rem':'1.15rem'};"></i>
                                    </div>
                                    <div>
                                        <div style="font-size:${IS_MOBILE?'0.95rem':'1.08rem'};font-weight:900;color:#fff;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">${empleo.titulo}</div>
                                        <div style="display:flex;gap:14px;flex-wrap:wrap;">
                                            <span style="font-size:0.68rem;color:rgba(255,255,255,0.4);display:flex;align-items:center;gap:4px;"><i class="fas fa-map-marker-alt" style="color:#0a84ff;font-size:0.6rem;"></i>${empleo.ubicacion||'Sin ubicación'}</span>
                                            <span style="font-size:0.68rem;color:rgba(255,255,255,0.4);display:flex;align-items:center;gap:4px;"><i class="fas fa-laptop-house" style="color:#0a84ff;font-size:0.6rem;"></i>${empleo.modalidad||'Presencial'}</span>
                                            <span style="font-size:0.68rem;color:rgba(255,255,255,0.4);display:flex;align-items:center;gap:4px;"><i class="fas fa-coins" style="color:#0a84ff;font-size:0.6rem;"></i>${fmtSal(empleo.salario)}</span>
                                        </div>
                                    </div>
                                </div>
                                <div style="display:flex;gap:6px;flex-wrap:wrap;">
                                    <span style="background:rgba(255,214,10,0.1);color:#ffd60a;padding:4px 11px;border-radius:50px;font-size:0.65rem;font-weight:700;border:1px solid rgba(255,214,10,0.22);display:flex;align-items:center;gap:4px;"><i class="fas fa-clock" style="font-size:0.6rem;"></i>${empleo.postulantes.filter(x=>!x.estado||x.estado==='pendiente').length} pendientes</span>
                                    <span style="background:rgba(48,209,88,0.1);color:#30d158;padding:4px 11px;border-radius:50px;font-size:0.65rem;font-weight:700;border:1px solid rgba(48,209,88,0.22);display:flex;align-items:center;gap:4px;"><i class="fas fa-check" style="font-size:0.6rem;"></i>${empleo.postulantes.filter(x=>x.estado==='aceptado').length} aceptados</span>
                                    <span style="background:rgba(255,59,48,0.1);color:#ff6b63;padding:4px 11px;border-radius:50px;font-size:0.65rem;font-weight:700;border:1px solid rgba(255,59,48,0.22);display:flex;align-items:center;gap:4px;"><i class="fas fa-times" style="font-size:0.6rem;"></i>${empleo.postulantes.filter(x=>x.estado==='rechazado').length} rechazados</span>
                                </div>
                            </div>
                            ...
                            <div style="display:flex;flex-direction:column;gap:9px;">
                                ${empleo.postulantes.map(p => {
                                    ...
                                    return `
                                    <div data-pid="${p.postulacion_id || (p.empleo_id + '_' + p.id)}" data-pnombre="${p.nombre}" style="display:flex;align-items:center;gap:${IS_MOBILE?'11px':'18px'};padding:${IS_MOBILE?'14px 16px':'18px 24px'};background:rgba(255,255,255,0.025);border:1px solid rgba(255,255,255,0.07);border-radius:16px;position:relative;overflow:hidden;transition:all 0.2s;">
                                        <div style="position:absolute;left:0;top:0;bottom:0;width:3.5px;background:linear-gradient(180deg,${accentColor},${accentColor}88);border-radius:3px 0 0 3px;"></div>
                                        <div style="flex-shrink:0;margin-left:6px;">
                                            ${hasFoto
                                                ? `<img src="${fotoUrl}" style="width:${IS_MOBILE?'42px':'50px'};height:${IS_MOBILE?'42px':'50px'};border-radius:50%;object-fit:cover;border:2.5px solid ${accentColor}55;box-shadow:0 0 0 3px ${accentColor}15,0 4px 12px rgba(0,0,0,0.3);">`
                                                : `<div style="width:${IS_MOBILE?'42px':'50px'};height:${IS_MOBILE?'42px':'50px'};border-radius:50%;background:linear-gradient(135deg,rgba(10,132,255,0.15),rgba(10,132,255,0.05));display:flex;align-items:center;justify-content:center;color:#0a84ff;font-size:${IS_MOBILE?'1.1rem':'1.3rem'};border:2px solid rgba(10,132,255,0.25);box-shadow:0 0 0 3px rgba(10,132,255,0.08);"><i class="fas fa-user"></i></div>`
                                            }
                                        </div>
                                        <div style="flex:1;min-width:0;">
                                            <div style="font-size:${IS_MOBILE?'0.87rem':'0.93rem'};font-weight:800;color:#fff;letter-spacing:0.3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">${p.nombre}</div>
                                            <div style="font-size:0.67rem;color:#0a84ff;font-weight:700;text-transform:uppercase;letter-spacing:0.8px;margin-top:2px;">${p.profesion||'Profesional'}</div>
                                            <div style="font-size:0.62rem;color:rgba(255,255,255,0.22);margin-top:5px;display:flex;align-items:center;gap:4px;"><i class="fas fa-calendar-alt" style="color:rgba(255,255,255,0.15);font-size:0.58rem;"></i>${dateStr}</div>
                                        </div>
                                        ${!IS_MOBILE && skills.length > 0 ? `<div style="display:flex;gap:5px;flex-wrap:wrap;min-width:130px;max-width:180px;justify-content:flex-end;">${skills.map(s=>`<span style="background:rgba(10,132,255,0.1);color:rgba(10,132,255,0.75);padding:3px 8px;border-radius:50px;font-size:0.62rem;font-weight:700;border:1px solid rgba(10,132,255,0.2);white-space:nowrap;">${s}</span>`).join('')}</div>` : ''}
                                        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:8px;flex-shrink:0;">
                                            ${p.estado === 'aceptado'
                                                ? `<span style="background:rgba(48,209,88,0.12);color:#30d158;padding:4px 12px;border-radius:50px;font-size:0.61rem;font-weight:700;border:1px solid rgba(48,209,88,0.28);text-transform:uppercase;letter-spacing:0.6px;white-space:nowrap;box-shadow:0 0 10px rgba(48,209,88,0.1);"><i class="fas fa-check" style="margin-right:3px;"></i>Aceptado</span>`
                                                : p.estado === 'rechazado'
                                                ? `<span style="background:rgba(255,59,48,0.1);color:#ff6b63;padding:4px 12px;border-radius:50px;font-size:0.61rem;font-weight:700;border:1px solid rgba(255,59,48,0.25);text-transform:uppercase;letter-spacing:0.6px;white-space:nowrap;"><i class="fas fa-times" style="margin-right:3px;"></i>Rechazado</span>`
                                                : `<span style="background:rgba(255,214,10,0.1);color:#ffd60a;padding:4px 12px;border-radius:50px;font-size:0.61rem;font-weight:700;border:1px solid rgba(255,214,10,0.22);text-transform:uppercase;letter-spacing:0.6px;white-space:nowrap;"><i class="fas fa-clock" style="margin-right:3px;"></i>Pendiente</span>`
                                            }
                                            <div style="display:flex;gap:6px;align-items:center;">
                                                <button onclick="abrirPerfilPostulante(${p.id})" style="padding:${IS_MOBILE?'7px 10px':'7px 14px'};border-radius:9px;background:rgba(10,132,255,0.1);border:1px solid rgba(10,132,255,0.22);color:#0a84ff;font-weight:700;font-size:0.68rem;cursor:pointer;font-family:inherit;display:flex;align-items:center;gap:5px;white-space:nowrap;"><i class="fas fa-eye" style="font-size:0.7rem;"></i>${IS_MOBILE?'':' Ver perfil'}</button>
                                                <div data-acciones style="display:flex;gap:6px;">
                                                    ${p.estado === 'aceptado' ? `
                                                        <div style="padding:7px 14px;border-radius:9px;background:rgba(48,209,88,0.08);border:1px solid rgba(48,209,88,0.22);color:#30d158;font-size:0.68rem;font-weight:700;display:flex;align-items:center;gap:4px;white-space:nowrap;"><i class="fas fa-check-circle"></i>${IS_MOBILE?'':' Aceptado'}</div>
                                                    ` : p.estado === 'rechazado' ? `
                                                        <div style="padding:7px 14px;border-radius:9px;background:rgba(255,59,48,0.08);border:1px solid rgba(255,59,48,0.22);color:#ff6b63;font-size:0.68rem;font-weight:700;display:flex;align-items:center;gap:4px;white-space:nowrap;"><i class="fas fa-times-circle"></i>${IS_MOBILE?'':' Rechazado'}</div>
                                                    ` : `
                                                        <button onclick="cambiarEstadoPostulante(this.closest('[data-pid]').dataset.pid,this.closest('[data-pid]').dataset.pnombre||'Candidato','aceptado',this)" style="padding:${IS_MOBILE?'7px 10px':'7px 15px'};border-radius:9px;background:linear-gradient(135deg,rgba(48,209,88,0.16),rgba(48,209,88,0.06));border:1.5px solid rgba(48,209,88,0.32);color:#30d158;font-weight:800;font-size:0.68rem;cursor:pointer;font-family:inherit;display:flex;align-items:center;gap:5px;white-space:nowrap;box-shadow:0 2px 8px rgba(48,209,88,0.12);"><i class="fas fa-user-check" style="font-size:0.7rem;"></i>${IS_MOBILE?'':' Aceptar'}</button>
                                                        <button onclick="cambiarEstadoPostulante(this.closest('[data-pid]').dataset.pid,this.closest('[data-pid]').dataset.pnombre||'Candidato','rechazado',this)" style="padding:${IS_MOBILE?'7px 10px':'7px 14px'};border-radius:9px;background:rgba(255,59,48,0.08);border:1px solid rgba(255,59,48,0.22);color:#ff6b63;font-weight:700;font-size:0.68rem;cursor:pointer;font-family:inherit;display:flex;align-items:center;gap:5px;white-space:nowrap;"><i class="fas fa-user-times" style="font-size:0.7rem;"></i>${IS_MOBILE?'':' Rechazar'}</button>
                                                    `}
                                                </div>
                                            </div>
                                        </div>
