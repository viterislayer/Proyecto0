                                ...
                                <div style="display:flex;align-items:center;gap:14px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="display:flex;gap:7px;flex-wrap:wrap;margin-top:8px;">
                                            <span style="background:rgba(255,214,10,0.08);color:#ffd60a;padding:3px 10px;border-radius:50px;font-size:0.66rem;font-weight:700;border:1px solid rgba(255,214,10,0.18);"><i class="fas fa-clock" style="margin-right:4px;"></i>${empleo.postulantes.filter(x => x.estado === 'pendiente' || !x.estado).length} pendientes</span>
                                            <span style="background:rgba(48,209,88,0.08);color:#30d158;padding:3px 10px;border-radius:50px;font-size:0.66rem;font-weight:700;border:1px solid rgba(48,209,88,0.18);"><i class="fas fa-check" style="margin-right:4px;"></i>${empleo.postulantes.filter(x => x.estado === 'aceptado').length} aceptados</span>
                                            <span style="background:rgba(255,59,48,0.08);color:#ff6b63;padding:3px 10px;border-radius:50px;font-size:0.66rem;font-weight:700;border:1px solid rgba(255,59,48,0.18);"><i class="fas fa-times" style="margin-right:4px;"></i>${empleo.postulantes.filter(x => x.estado === 'rechazado').length} rechazados</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="glass" style="border-radius:20px;border:1px solid rgba(255,255,255,0.07);overflow:hidden;display:flex;flex-direction:column;transition:0.2s;width:320px;flex-shrink:0;">
                                        ...
                                        <div style="background:linear-gradient(135deg,rgba(10,132,255,0.1),rgba(10,132,255,0.03));padding:24px 20px 18px;text-align:center;border-bottom:1px solid rgba(255,255,255,0.05);">
                                            ...
                                            <div style="margin-top:10px;">
                                                ${p.estado === 'aceptado'
                                                    ? `<span style="background:rgba(48,209,88,0.12);color:#30d158;padding:4px 13px;border-radius:50px;font-size:0.65rem;font-weight:700;border:1px solid rgba(48,209,88,0.28);text-transform:uppercase;letter-spacing:0.8px;"><i class="fas fa-check" style="margin-right:4px;"></i>Aceptado</span>`
                                                    : p.estado === 'rechazado'
                                                    ? `<span style="background:rgba(255,59,48,0.1);color:#ff6b63;padding:4px 13px;border-radius:50px;font-size:0.65rem;font-weight:700;border:1px solid rgba(255,59,48,0.25);text-transform:uppercase;letter-spacing:0.8px;"><i class="fas fa-times" style="margin-right:4px;"></i>Rechazado</span>`
                                                    : `<span style="background:rgba(255,214,10,0.1);color:#ffd60a;padding:4px 13px;border-radius:50px;font-size:0.65rem;font-weight:700;border:1px solid rgba(255,214,10,0.2);text-transform:uppercase;letter-spacing:0.8px;"><i class="fas fa-clock" style="margin-right:4px;"></i>Pendiente</span>`
                                                }
                                            </div>
                                        </div>
                                        <!-- Contenido -->
                                        ...
                                        <div style="padding:0 16px 16px;display:flex;flex-direction:column;gap:8px;">
                                            ...
                                            ${p.estado === 'aceptado' ? `
                                            <div style="text-align:center;padding:13px;border-radius:14px;background:linear-gradient(135deg,rgba(48,209,88,0.12),rgba(48,209,88,0.04));border:1px solid rgba(48,209,88,0.3);font-size:0.82rem;font-weight:800;color:#30d158;letter-spacing:0.3px;"><i class="fas fa-check-circle" style="margin-right:7px;"></i>Candidato Aceptado</div>
                                            ` : p.estado === 'rechazado' ? `
                                            <div style="text-align:center;padding:13px;border-radius:14px;background:linear-gradient(135deg,rgba(255,59,48,0.1),rgba(255,59,48,0.03));border:1px solid rgba(255,59,48,0.28);font-size:0.82rem;font-weight:800;color:#ff6b63;letter-spacing:0.3px;"><i class="fas fa-times-circle" style="margin-right:7px;"></i>Candidato Rechazado</div>
                                            ` : `
                                            <div data-acciones style="display:flex;flex-direction:column;gap:7px;">
                                                <button onclick="cambiarEstadoPostulante(window.postulantesCache[${p.id}]?.postulacion_id,window.postulantesCache[${p.id}]?.nombre||'Candidato','aceptado',this)" style="width:100%;padding:13px;border-radius:13px;background:linear-gradient(135deg,rgba(48,209,88,0.14),rgba(48,209,88,0.05));border:1.5px solid rgba(48,209,88,0.35);color:#30d158;font-weight:800;font-size:0.85rem;cursor:pointer;font-family:inherit;transition:all 0.2s;display:flex;align-items:center;justify-content:center;gap:9px;">
                                                    <i class="fas fa-user-check"></i> Aceptar Candidato
                                                </button>
                                                <button onclick="cambiarEstadoPostulante(window.postulantesCache[${p.id}]?.postulacion_id,window.postulantesCache[${p.id}]?.nombre||'Candidato','rechazado',this)" style="width:100%;padding:10px;border-radius:12px;background:rgba(255,59,48,0.07);border:1px solid rgba(255,59,48,0.22);color:rgba(255,107,99,0.85);font-weight:700;font-size:0.78rem;cursor:pointer;font-family:inherit;transition:all 0.2s;display:flex;align-items:center;justify-content:center;gap:7px;">
